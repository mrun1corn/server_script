...
install_cacti() {
    ...
    #config file of apache for cacti
    sudo curl -s https://raw.githubusercontent.com/mrun1corn/Server_script/main/cacti.conf -o /etc/apache2/sites-enabled/cacti.conf
